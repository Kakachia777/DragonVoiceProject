...
class DragonVoiceGUI:
    ...
    def create_dashboard_tab(self):
        ...
        self.text_display.insert(
            "end",
            "Voice commands will appear here after you click 'Start Voice Assistant'.\n\n")
...
Special thanks to all contributors and users who have helped improve DragonVoice.""")
    ...
    def toggle_voice_assistant(self):
        ...
        if hasattr(self, 'recording_active') and self.recording_active:
            ...
            if hasattr(self, 'toggle_button'):
                self.toggle_button.configure(text="Start Voice Assistant")
    ...
    def create_config_tab(self):
        ...
        # Add separator with fallback color
        separator_color = self.colors.get("bg_light", "#313244")  # Use bg_light as fallback
