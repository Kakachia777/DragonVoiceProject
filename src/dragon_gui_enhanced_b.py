...
class DragonVoiceGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Dragon Voice B")
    ...
    def create_header_frame(self):
        ...
        version_label = ttk.Label(title_frame, text="Computer B Edition", 
    ...
    def setup_styles(self):
        """Setup ttk styles for modern look with blue theme"""
        style = ttk.Style()
        
        # Configure button styles with blue theme
        ...
        # Override default colors with blue theme
        style.map("TButton", 
...
For more help, visit: https://dragonvoice.example.com/help
    ...
    def gui_confirm_transcription(self, text):
        ...
        title_label = ttk.Label(main_frame, text="Confirm Transcription", 
                             font=("Segoe UI", 16, "bold"), foreground="#0078d4")
        title_label.pack(anchor="w", pady=(0, 15))
