...
class DragonVoiceGUI:
    ...
    def bind_shortcuts(self):
        ...
        # Use Space for recording instead of Enter
        self.root.bind('<space>', lambda e: self.start_recording_key(True))
        self.root.bind('<KeyRelease-space>', lambda e: self.start_recording_key(False))
        ...
        if is_pressed:
            ...
            if not self.recording_active:
                ...
                if isinstance(self.record_button, RecordButton):
                    ...
                    self.record_button.config(text="Recording... (Release Space to stop)")
    ...
    def create_main_buttons(self):
        ...
        # Description
        desc_label = ttk.Label(record_card, text="Press and hold Space to record", style="CardDesc.TLabel")
    ...
    def create_text_input_area(self):
        ...
        send_btn = ttk.Button(btn_frame, text="Send to Chatbots (Enter)",
    ...
    def _send_thread(self):
        ...
        try:
            ...
            # Send to chatbots
            if hasattr(self.app, 'input_to_chatbots') and hasattr(self.app, 'last_transcription'):
    ...
    def create_footer(self):
        ...
        shortcut_label = ttk.Label(footer_frame, 
                                 text="Shortcuts: Space=Record (hold), Enter=Send, F10=Quick Mode, F11=Retry, F12=Settings",
...
MAIN FEATURES:
--------------
• Record Voice: Press and hold Space to record. Speak clearly, and the app will transcribe your speech.
...
KEYBOARD SHORTCUTS:
------------------
Space - Press and hold to record (release to stop)
