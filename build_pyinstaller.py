...
def build_dragon_voice():
    ...
    try:
        ...
        cmd = [
            ...
            "dragon_voice_enhanced.py"  # Use our enhanced file with hardcoded coordinates
        ]
        ...
        shutil.copy("dragon_voice_enhanced.py", "output/DragonVoice/")
        ...
        with open("output/DragonVoice/README.txt", "w") as f:
            ...
            f.write("FEATURES:\n")
            f.write("- Uses hardcoded chatbot coordinates directly in the script\n")
            f.write("- Supports custom key presses for different chatbot interfaces\n")
            f.write("- Includes Test Coordinates button to verify coordinates work\n\n")
            ...
            f.write("3. For reliable cross-computer interaction, increase delays in Settings\n\n")
